    ...
    <div className="grid grid-cols-3 gap-6 flex-1">
      ...
      <div className="col-span-2 flex flex-col gap-6">
        ...
        <div className="bg-white p-6 rounded-3xl shadow-soft relative overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-green-100 rounded-full blur-3xl opacity-50 -mr-20 -mt-20" />
          ...
          <div className="flex justify-between items-start mb-6 relative z-10">
            <div>
              ...
              <div className="text-4xl font-black mb-1">$ 110,450</div>
              <div className="text-sm text-gray-500">
                <span className="text-green-500 font-semibold flex items-center gap-1 inline-flex">
            ...
            <div className="flex gap-2">
              <button className="bg-gray-50 hover:bg-gray-100 text-gray-700 px-4 py-2 rounded-full text-sm font-medium flex items-center gap-2 border border-gray-100">
                Month <i className="fas fa-chevron-down text-xs" />
              </button>
              <button className="w-10 h-10 rounded-full bg-gray-50 hover:bg-gray-100 flex items-center justify-center border border-gray-100 text-gray-500">
          ...
          {/* Chart Area */}
          <div className="h-80 relative z-10 mt-10">
            {/* Y Axis */}
            ...
            {/* Bars */}
            <div className="ml-10 h-full flex items-end justify-between pb-8 pt-4">
              {[
                ...
                return (
                  ...
                  >
                    {bar.active && (
                      <>
                        <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSI0IiBoZWlnaHQ9IjQiPjxyZWN0IHdpZHRoPSI0IiBoZWlnaHQ9IjQiIGZpbGw9IiNmZmYiIGZpbGwtb3BhY2l0eT0iMC4wNSIvPjwvc3ZnPg==')] opacity-50 rounded-t-2xl mix-blend-overlay" />
                        {/* Tooltip */}
                        <div className="absolute -top-28 left-1/2 -translate-x-1/2 bg-[#1A1D21] text-white p-3 rounded-xl w-40 text-xs shadow-2xl z-30">
                    ...
                    <div
                      className={`absolute -top-3 left-1/2 -translate-x-1/2 text-white text-[10px] font-bold px-1.5 py-0.5 rounded-full z-20 ${bar.color}`}
                    >
                      {bar.pct}
                    </div>
                  </div>
            ...
            {/* X Axis Labels */}
            <div className="absolute bottom-0 left-10 right-0 flex justify-between text-xs text-gray-400 font-medium px-4">
              <span>Jan</span>
              <span>Feb</span>
              <span>Mar</span>
              <span>Apr</span>
          ...
          {/* Legend */}
          <div className="absolute top-8 right-32 flex gap-4 text-xs text-gray-500">
            <span className="flex items-center gap-1">
        ...
        {/* Recent Transactions */}
        <div className="bg-white p-6 rounded-3xl shadow-soft flex-1">
          <div className="flex justify-between items-center mb-6 flex-wrap gap-4">
            ...
            <div className="flex items-center gap-2 flex-wrap">
              <div className="relative">
                ...
                <input
                  className="bg-gray-50 border border-gray-100 rounded-full py-2 pl-9 pr-4 text-sm w-48 focus:outline-none"
                  placeholder="Search..."
                  type="text"
                />
              </div>
              <button className="bg-gray-50 border border-gray-100 px-3 py-2 rounded-full text-sm font-medium flex items-center gap-2 text-gray-700">
              ...
              <button className="bg-black text-white px-4 py-2 rounded-full text-sm font-medium flex items-center gap-2 hover:bg-gray-800">
                ...
                {[
                  ...
                  >
                    ...
                    <td className="py-3 text-center">
                      <span
                        className={`${row.statusClass} px-3 py-1 rounded-full text-xs font-medium`}
                      >
                        {row.status}
                      </span>
                    </td>
      ...
      <div className="col-span-1 flex flex-col gap-6">
        ...
        <div className="bg-white p-6 rounded-3xl shadow-soft">
          ...
          <div className="flex justify-between border-t border-gray-100 pt-6 mb-4">
            <div>
        ...
        <div className="bg-white p-6 rounded-3xl shadow-soft">
          ...
          <div className="space-y-3">
            {[
              ...
              <div
                key={market.country}
                className="flex items-center justify-between p-3 border border-gray-100 rounded-2xl"
              >
                <div className="flex items-center gap-3">
                  {market.flag}
                ...
                <div className="flex items-center gap-3">
                  <span className="font-bold text-sm">{market.amount}</span>
        ...
        {/* Top Product */}
        <div className="bg-gradient-to-br from-green-50 to-white p-6 rounded-3xl shadow-soft relative overflow-hidden flex-1">
          ...
          <div className="grid grid-cols-2 gap-4 relative z-10">
            <div className="bg-gray-900 rounded-2xl p-4 text-white shadow-xl flex flex-col justify-between">
              ...
              <div>
                <div className="font-bold text-sm mb-1">AeroPods Lite</div>
            ...
            <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100 flex flex-col justify-between">
              <div className="w-10 h-10 bg-gray-50 rounded-xl flex items-center justify-center mb-4 border border-gray-100 text-xl">
                💾
              </div>
              <div>
                <div className="font-bold text-sm mb-1">HyperDrive SSD</div>
