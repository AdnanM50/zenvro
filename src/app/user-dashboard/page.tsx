...
export default function UserDashboardPage() {
  return (
    <div className="flex w-full p-4 gap-4 overflow-y-auto">
      {/* Sidebar */}
      <aside className="group w-20 hover:w-64 bg-white rounded-3xl flex flex-col items-center py-6 shadow-sm justify-between z-50 transition-all duration-300 ease-in-out">
        <div className="flex flex-col items-center gap-8 w-full px-4">
          <div className="w-10 h-10 bg-black rounded-xl flex items-center justify-center text-white font-bold text-xl shrink-0">
            S
          </div>
        ...
        <div className="flex flex-col gap-2 bg-gray-100 p-1.5 rounded-full">
          <button className="w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-sm text-yellow-500">
