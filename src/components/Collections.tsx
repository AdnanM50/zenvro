...
const collectionsData = [
  {
    ...
    image:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuAN8FAzZ6Z98nZ8sYGleNSAKoti9_iF3fu8z7I65Bw3HONXl-SUhJFYxpU2jhhzXvfS9KTh-dHu4EE8Y2dcvTOb06mudpwFstqK7Iivzugrvbf-uf2_72GnEVFBZEkoflE7ChpGtu1ql9yTVkx2L25xQ62yFuKTcVw0oYF85SEBPSiWSpCN1Rigaj21UKn4GdayMsDE64POVE4d_jGtny91Wtv11ljhddqyuDDKA497rJFWHbwFER3RnmpWT3aF108NvbpfXEUdehWf",
  },
  {
    id: 2,
    title: "Everyday Essentials 2026",
    description:
      "Modern essentials designed for the rhythm of your daily life.",
    image:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuDSUs8fzjaFq_UgiWHvEzssIE8LZz9u9S90I27yrJOmb8d9gRWmzjPxDqM7DXIlkP5iVLDm18Jil46QbiF_nWze1U6u45vN3tyoOfZeruHZhlvjTGDwSMZkTAdI3Zn7pdcPEntaCKxCTnZDDy3aY_3Vsx0ezQCPj1USMTLR7BDWozA0Usj2EpH4L7aGRTq4d-02iWLb3HUpBLgbuIQEhPOM-5JCNVA16Eze95sfztoWgSUCVbhGV_3DERa3OJo2wHqZVKc61zKD7UCq",
  },
  {
    id: 3,
    title: "Timeless Classics 2026",
    description:
      "Enduring pieces that transcend seasons and trends with effortless grace.",
    image:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuD1RoW5cBcoqT10u7JT7K7anHFGjv3NTjr8_mysaiCsk27iFErOxdP6goslnhBKFrJAC_iy8B-WQiIX7V9Tfq3ZQQ0DbKX0r3VZWRvRL8rx9a5vZ6yrB9wQOagG01U8I61_Y8LQ3h4X_uq6u5aA3yI1A8TPHK0I6FEbFTGhj8IPMtbCubZDYHng1tq9dl0pwI8nDdjwgiNLq4eIJQQwAMDg4xcvoJK2t1TVCM5VYhXT2E4qhkIg7Sq7cXGPMSQGBTsIMkBZr007K2R_",
  },
  {
    id: 4,
    title: "Seasonal Collections 2025",
    description:
      "Fresh arrivals curated for the current season's palette and mood.",
    image:
    ...
    <section className="relative" id="collections-section">
            ...
            >
              {marqueeItems.map((text, i) => (
                <span key={`${setIndex}-${i}`} className="flex items-center">
                  <span className="font-label text-[11px] font-bold tracking-[0.2em] uppercase text-on-surface px-4">
                    {text}
                  </span>
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-16 py-12 md:py-20">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 md:gap-12 lg:gap-20 items-start">
          {/* ─── Left Side: Clip-Path Image ─── */}
          <div className="md:col-span-5 flex flex-col">
            {/* Intro text */}
            <p className="font-body text-[13px] text-secondary leading-[1.7] max-w-[250px] mb-6">
              From enduring classics to daring statement
              {" "}pieces, our collections are crafted with intention.
            </p>

            {/* Main model image with geometric clip-path */}
            <div className="relative">
              <div className="collections-image-clip w-full overflow-hidden bg-surface-container">
                <img
                  className="w-full h-full object-cover object-top"
                  alt="Fashion model in minimalist light grey outfit"
            ...
            {/* Caption below image */}
            <p className="font-body text-[12px] text-secondary mt-6 tracking-wide">
              Being Part Of Our Journey.
            </p>
          </div>

          {/* ─── Right Side: Accordion List ─── */}
          <div className="md:col-span-7 flex flex-col pt-0 md:pt-8">
            {collectionsData.map((item, index) => (
              <div
                key={item.id}
                className={`collections-accordion-item border-b border-outline-variant ${
                  index === 0 ? "border-t" : ""
                }`}
                onMouseEnter={() => setActiveItem(index)}
              >
                {/* Row: heading + right element */}
                <div className="py-5 md:py-6 flex items-start justify-between cursor-pointer gap-6">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div
                      className={`collections-expand overflow-hidden transition-all duration-500 ease-[cubic-bezier(0.4,0,0.2,1)] ${
                        activeItem === index
                          ? "max-h-[220px] opacity-100 mt-4"
                          : "max-h-0 opacity-0 mt-0"
                      }`}
                    >
                      <p className="font-body text-[13px] text-secondary leading-relaxed max-w-[330px] mb-5">
                        {item.description}
                      </p>
                      <button className="collections-cta border border-on-surface rounded-full px-6 py-2.5 font-label text-[11px] font-bold tracking-[0.15em] uppercase flex items-center gap-3 hover:bg-primary hover:text-white hover:border-primary transition-all duration-300">
                        GET STARTED
                  ...
                  {/* Right: Thumbnail (active) or Arrow (inactive) */}
