    ...
    <section className="min-h-screen pt-24 pb-12 px-6 md:px-12 max-w-[1600px] mx-auto relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
        ...
        <div className="lg:col-span-8 order-1 lg:order-2 flex flex-col justify-center gap-12">
          ...
          <div className="flex flex-col gap-4 border-l-2 border-primary-fixed pl-8">
      ...
      {/* Navigation Controls */}
      <div className="flex justify-between items-center mt-20 md:mt-32">
        <button className="w-16 h-16 rounded-full border border-outline-variant flex items-center justify-center hover:bg-black hover:text-white transition-all duration-300 group">
        ...
        <button className="w-16 h-16 rounded-full bg-black text-white flex items-center justify-center hover:bg-primary-fixed transition-all duration-300 group">
